...
| `android.permission.READ_EXTERNAL_STORAGE` | Required to access pictures in the phone galary. |
| `android.permission.WRITE_EXTERNAL_STORAGE` | Required to save pictures to the phone galary. |
